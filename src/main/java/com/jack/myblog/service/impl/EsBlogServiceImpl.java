...
import com.jack.myblog.dao.es.EsBlogDao;
...
import com.jack.myblog.vo.TagVO;
...
public class EsBlogServiceImpl implements EsBlogService {
	...
	public Page<EsBlog> listNewestEsBlogs(String keyword, Pageable pageable) throws SearchParseException {
		...
		pages = esBlogDao.findDistinctEsBlogByTitleContainingOrSummaryContainingOrContentContainingOrTagsContaining(keyword,keyword,keyword,keyword, pageable);
